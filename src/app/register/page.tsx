...
export default function page() {
	return (
		<section className="px-4">
			<section>
				<h1 className="text-xl mb-1 font-bold ">Register</h1>
				<Link href="/login">
					<p className="underline text-sm">
						Do you have an account? Log in here
					</p>
				</Link>
				<p className="mt-2 text-sm">Sign up with:</p>
				...
				<p className="uppercase text-base font-semibold text-center text-mainBlue">or</p>
				<form action="">
					<input
						type="email"
						placeholder="Email"
					...
					/>
					<p className="text-xs">
						Minimum 8 chararcters with at least one uppercase, one lowercase, one number and one special
						character
					</p>
					<input
						type="password"
						...
						className="border-2 rounded-lg p-2 border-darkGray/50 w-full my-2 bg-transparent placeholder:capitalize placeholder:text-sm outline-none"
					/>
					<div className="flex items-center justify-between text-white bg-darkGray rounded-lg p-4 mt-3">
				...
				<p className=" text-xs mt-2 mb-6 font-semibold">
					By clicking register, you agree to our website KicksClub
